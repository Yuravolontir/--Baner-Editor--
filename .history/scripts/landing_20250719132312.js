...
function updateCTAColor(){
    ...
    if (button) {
        button.style.backgroundColor = document.getElementById("BackgroundColor").value;
    }
...
function updateLandingPageTemplate() {
    ...
    const h1 = document.createElement("h1");
    h1.id = "H1";
    h1.textContent = document.getElementById("Heading").value || "Your Heading";
    h1.style.textAlign = "center";

    const pre = document.createElement("pre");
    pre.id = "Pre";
    pre.textContent = document.getElementById("Text").value || "Some supporting text.";
    pre.style.textAlign = "center";
    ...
    const img = document.createElement("img");
    img.id = "ImageToAdd";
    img.src = document.getElementById("addimageInput").value || "https://via.placeholder.com/200";
    img.style.objectFit = "cover";
    ...
    switch (selectedTemplate) {
        ...
        case "template2": // Gradient dark
            div.style.background = "linear-gradient(135deg, #1d1d1d, #3a3a3a)";
    ...
    // Ensure manual updates continue to work
    updateHeading();
    updateText();
