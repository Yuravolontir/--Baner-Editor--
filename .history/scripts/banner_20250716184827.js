 ...
 function updateDesignStyle() {
    ...
    switch (style) {
        case "minimal":
            ...
            document.getElementById("TextColor").dispatchEvent(new Event("input")); // Also update bannerPre
            document.getElementById("text-font").value = "Inter";
            document.getElementById("text-font").dispatchEvent(new Event("input"));
            break;
        ...
        case "bold":
            ...
            document.getElementById("BackgroundColor").value = "#ffffff"; // Not used, but just in case
            document.getElementById("TextColor").value = "#ffffff";
            document.getElementById("TextColor").dispatchEvent(new Event("input"));
            document.getElementById("text-font").value = "Rubik";
            document.getElementById("text-font").dispatchEvent(new Event("input"));
            break;
        ...
        case "pixel":
            ...
            document.getElementById("HeadingColor").value = "#00ff00";
            document.getElementById("TextColor").value = "#00ff00";
            document.getElementById("TextColor").dispatchEvent(new Event("input"));
            document.getElementById("text-font").value = "'Press Start 2P'";
            document.getElementById("text-font").dispatchEvent(new Event("input"));
            break;
    }
