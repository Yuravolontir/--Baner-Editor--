...
document.getElementById("submit-register").addEventListener("click", storeUsersData);

document.getElementById("submit-login").addEventListener("click", checkUsersData);
