...
function SaveLandingPage(event)
{
        ...
        let minHeight = banner.style.minHeight;
        ...
        let imageborderRadius = document.getElementById("imageBorderRadius").value;
        let designstyle = document.getElementById("designStyle").value;
        let leadform = document.getElementById("leadFormToggle").value;cument.getElementById("copyHTML").addEventListener("click", () => {
        const page = document.getElementById("generatedLandingPage");
        if (!page) {
