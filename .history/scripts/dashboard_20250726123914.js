...
//----------------------------------------------------------------------------------
            ...
            // Add event listener for the download button
downloadbutton.addEventListener("click", () => {
    // Netlify lead form HTML (conditionally inserted)
    ...
    // Build the full HTML string, injecting the lead form after the existing content inside <body>
    const htmlContent = `
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <script>
        ...
        if (cta) {
            cta.addEventListener("click", () => {
                ...
                if (cta.className === "Behavior1") {
                    window.location.href = "tel:" + cta.getAttribute("data-link");
                }
                if (cta.className === "Behavior2") {
