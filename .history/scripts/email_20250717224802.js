...
function SaveEmailBanner(event) {
    ...
    let newEmailBanner = new emailBanner(width, minHeight, hedingtext, maintext, backgroundcolor, headingcolor, textcolor, headingfont, textfont, headingfontsize, textfontsize, designstyle, image, username);
