        ...
        if (b.username === currentUser) 
        {
            ...
            if (b.template=="default")
            {
                ...
                cta.addEventListener("click", () => {
                        ...
                        {
                            cta.datalink = b.ctainput;
                            cta.style.className = "default";
                            window.location.href = b.ctainput;
                        }

                    if (b.ctabehavior === "Behavior1") // phone call
                        {
                            cta.style.className = "Behavior1";
...
<head>
    ...
    <style>
        ...
        .landing-page {
            ...
            min-height: ${page.style.minHeight};
            ...
            background-image: ${page.style.backgroundImage};
            background-size: ${page.style.backgroundSize};
            background-repeat: ${page.style.backgroundRepeat};
            background-position: ${page.style.backgroundPosition};
