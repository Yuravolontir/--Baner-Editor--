...
export class emailBanner
{
    ...
    constructor( width, height,hedingtext, maintext, backgroundcolor, headingcolor, textcolor, headingfont, textfont, headingfontsize, textfontsize, designstyle, image, username) {
        this.width = width;
        this.height = height;
        this.hedingtext = hedingtext;
        this.maintext = maintext;
