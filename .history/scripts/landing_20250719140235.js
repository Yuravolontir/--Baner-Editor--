...
function updateLandingPageTemplate() {
    ...
    const h1 = document.createElement("h1");
    h1.id = "H1";
    document.getElementById("Heading").value =  "Welcome to Our Landing Page";
    h1.textContent = document.getElementById("Heading").value;
    h1.style.textAlign = "center";

    const pre = document.createElement("pre");
    pre.id = "Pre";
    document.getElementById("Text").value = "Your landing page text goes here.";
    pre.textContent = document.getElementById("Text").value ;
    pre.style.textAlign = "center";
    ...
    const img = document.createElement("img");
    img.id = "ImageToAdd";
     img.src = document.getElementById("addimageInput") =  "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQOiVTtmHy1IPxGhMuuoxwWz-kjqEkyi8Vc-w&s";
    img.src = document.getElementById("addimageInput").value ;
    img.style.objectFit = "cover";
    ...
    switch (selectedTemplate) {
        case "template1": // Clean & white
            div.style.backgroundColor = "linear-gradient(135deg, #d0cdb9ff, #cdc007ff)";
            h1.style.color = "#222";
            pre.style.color = "#333";
        ...
        case "template2": // Gradient dark
            div.style.background = /* The above code is creating a linear gradient background with a
            135-degree angle, transitioning from the color #1d1d1d to the
            color #3a3a3a. */
            "linear-gradient(135deg, #1d1d1d, #3a3a3a)";
            h1.style.color = "#f8f8f8";
            pre.style.color = "#d0d0d0";
            cta.style.backgroundColor = "#ff6b6b";
            cta.style.color = "#fff";
                div.appendChild(h1);
                div.appendChild(img);
                div.appendChild(pre);
        ...
        case "template3": // Peach vibes
            ...
            h1.style.color = "#333";
            pre.style.color = "#4d4d4d";
            cta.style.backgroundColor = "#e75480";
            cta.style.color = "#fff";
                div.appendChild(img);
                div.appendChild(cta);
                div.appendChild(h1);
