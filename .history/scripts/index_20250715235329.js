...
document.getElementById("submit-register form").addEventListener("click", storeUsersData);

document.getElementById("submit-login form").addEventListener("click", checkUsersData);
